...
<a href="https://www.northeastern.edu/" id="wd-neu-link" target="_blank" className="list-group-item bg-black border-0 text-center">
    <img src="NU.png" alt="Northeastern University logo" style={{ width: "52px" }} />
</a><br/>
      ...
      <Link to="/" id="wd-labs-link"  className={location.pathname === "/Kanbas/Labs" ? activeStyle : defaultStyle}> <LiaCogSolid className="fs-1 text-danger" /><br />Labs</Link><br/>
    </div>
);}
